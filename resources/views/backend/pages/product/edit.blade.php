                ...
                <div class="card-body">
                    <form action="{{route('products.update',$product->product_slug)}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input value="{{$product->product_name}}" type="text" class="form-control @error('product_name')
                                is-invalid
                        ...
                        <div class="d-flex justify-content-between">
                            <div class="col-md-5 mb-3">
                                ...
                                <input type="number" value="{{$product->product_price}}" class="form-control @error('product_price')
                                    is-invalid
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" value="{{$product->product_code}}" class="form-control @error('product_code')
                                    is-invalid
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <div class="col-md-5 mb-3">
                                ...
                                <input type="number" value="{{$product->product_stock}}" class="form-control @error('product_stock')
                                    is-invalid
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" value="{{$product->alert_quentity}}" class="form-control @error('alert_quentity')
                                    is-invalid
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="product_short_description" class="form-control" id="product_short_description" cols="30" rows="5">{{$product->product_short_description}}</textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="product_long_description" class="form-control" id="product_long_description" cols="30" rows="10">{{$product->product_long_description}}</textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="file" class="dropify @error('product_image')
                                is-invalid
                            @enderror" name="product_image" data-default-file="{{asset('uploads/product')}}/{{$product->product_image}}" id="product_image">
                            @error('product_image')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{$message}}</strong>
                            </span>
